      ...
      >
        ...
        <div className="flex flex-col items-center text-center gap-6">
          ...
          <div className="space-y-2">
            <h2 className="text-2xl font-black uppercase tracking-tighter text-white">Contenido +18</h2>
            <p className="text-slate-400 text-sm leading-relaxed">
              Este modo contiene retos para adultos. Ingresa tu fecha de nacimiento para continuar.
            </p>
          </div>

          <div className="w-full space-y-3">
            <label className="block text-left text-[10px] font-black text-pink-500 uppercase tracking-widest mb-1">
              Fecha de nacimiento
            </label>
            <input
              type="date"
              ...
              className="w-full px-4 py-3 rounded-2xl bg-white/5 border border-white/10 text-white text-sm font-bold focus:outline-none focus:border-pink-500 transition-colors"
            ...
            {error && (
              <motion.p
                ...
                className="text-red-400 text-xs font-bold text-left px-1"
              >
                {error}
              </motion.p>
            )}
          ...
          <div className="bg-white/5 rounded-2xl p-4 border border-white/5 w-full">
            <p className="text-[10px] uppercase font-black tracking-widest text-pink-500 mb-1">Advertencia Legal</p>
            <p className="text-[11px] text-slate-500 italic">
              Al continuar confirmas que tienes 18 años o más y aceptas acceder a contenido para adultos.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3 w-full">
            ...
            <button
              onClick={() => { hapticFeedback(10); onCancel(); }}
